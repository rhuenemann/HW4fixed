...
public class UpdateFormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //use ReadRecord to get the xboxgame data
        rr.doRead();
        Xboxgames xboxgame = rr.getXboxgame();
        
        //pass xboxgame and control to updateForm.jsp
        request.setAttribute("xboxgame", xboxgame);
